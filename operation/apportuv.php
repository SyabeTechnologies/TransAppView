...
<head>  
  <meta charset="utf-8" />
  <title>Operation | Apport UV </title>
...
<form method="post" action="apportuv_process.php">
    <p class="h4 text-center mb-4">Nouveau Apport UV</p>
    <br>

    <!-- Material input montant -->
    <div class="md-form ">
        
        <input type="Date" id="date" class="form-control" name="date" value="<?php echo date("Y-m-d");?>"readonly>
        <label for="materialFormSubscriptionNameEx">Date d'aujourd'hui</label>
    </div>
    <br>
    ...
    <div class="md-form">
        ...
        <label for="materialFormSubscriptionEmailEx">Montant de l'UV</label>
    </div>
    <br>
...
<!-- Fin de l'appel de l'API activité-->
     <div class="form-group">
              <select class="form-control" id="activiteid" name="activiteid" required autofocus>
