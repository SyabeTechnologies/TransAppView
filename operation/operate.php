...
<head>  
  <meta charset="utf-8" />
  <title>Operation | Initialisation UV</title>
...
<form method="post" action="operate_process.php">
    ...
    <div class="md-form">
        ...
        <input type="number" id="uv" class="form-control" name="uv" required autofocus>
