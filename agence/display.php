  ...
  <section class="vbox">
              ...
              <section class="vbox">
                ...
                <center>
                  ...
                  <section class="row m-b-md">
                    <div>
                      <center><h3 class="m-b-xs text-black">LISTE DES TRANSACTION</h3></center>
                    </div>
                  </section>
                  <div class="row">
    ...
    <section class="content">
      ...
      <?php
          ...
          $url = $connapi."Transaction/select.php";
                         ...
                         <?php 
                          ...
                          {  
                            foreach($result->data as $roito) 
                            {
                              ...
                              echo "<td>" . number_format($roito->Montant, 0, ',', ' ') . "</td>";
                              echo "<td>" . $roito->Numero . "</td>";
                              echo "<td>" . $roito->Type . "</td>";
                              echo "<td>" . $roito->Activite . "</td>";
                              echo "<td>" . $roito->User . "</td>";
                              echo "</tr>";      
                              }                         
                            } 
                          } 
